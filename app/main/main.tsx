...
export function Main({ message }: { message: string }) {
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Blue Hero */}
      <section className="relative bg-gradient-to-b from-indigo-600 to-indigo-500 pt-12 pb-24 px-4">
        ...
        {/* Info card overlay */}
        <div className="relative z-10 w-full max-w-[1100px] mx-auto mt-8 px-4">
      ...
      <section className="relative">
        {/* Placeholder for now – we’ll drop React-Leaflet in next */}
        <div
          id="map"
